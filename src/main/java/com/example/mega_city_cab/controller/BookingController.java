...
@RestController
@CrossOrigin(origins = "*")
@RequestMapping(value = "/auth/bookings")  // Updated to match plural form
@Slf4j
public class BookingController {
    ...
    @GetMapping("/getallbookings")  // Added endpoint to get all bookings
    ...
    @GetMapping("/getallcustomerbookings")  // Updated endpoint name for consistency
